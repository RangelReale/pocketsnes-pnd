...
EXTERN_C struct SSA1Registers SA1Registers;
EXTERN_C struct SSA1 SA1;

EXTERN_C uint8 *SA1_Map [MEMMAP_NUM_BLOCKS];
EXTERN_C uint8 *SA1_WriteMap [MEMMAP_NUM_BLOCKS];
